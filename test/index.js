...
const bucketId = 37;
const videoCid = "bafk2bzacedf23brtvstaxbz77nfukr4snoxfbndzkt5aedxd3f5qowtx6tugo";

/* object responsible for file downloading */
const downloader = new Downloader(bucketId, videoCid);
...
function load() {
	...
	mp4boxfile.onMoovStart = function () {
		console.debug("Application", "Starting to parse movie information");
	}
	mp4boxfile.onReady = function (info) {
		console.debug("Application", "Movie information received");
		movieInfo = info;
